...
var SignalingChannel = function(wssUrl, wssPostUrl) {
  ...
  this.registeredforme_ = false ;// here registeredforme durumu bakiliyor
  // Public callbacks. Keep it sorted.
  this.onerror = null;
  this.onmessage = null;
};

// open function nerede cagriliyor 
...
//To Do Irma: registerforme 
SignalingChannel.prototype.registerforme = function(clientId) {
  ...
  var registerformeMessage = {
    cmd: 'registerforme',
    roomid: "--",
    clientid: clientId, 
  };
  this.websocket_.send(JSON.stringify(registerformeMessage));
  this.registeredforme_ = true;
